...
public class DataHandlerTest {
    ...
    void testToGetDayWithSmallestTempSpread() {
        WeatherDataPoint day1 = new WeatherDataPoint("1", 14, 3, 11f);
        WeatherDataPoint day2 = new WeatherDataPoint("2", 4, 3, 1f);
        WeatherDataPoint day3 = new WeatherDataPoint("3", 20, 3, 17f);
        WeatherDataPoint day4 = new WeatherDataPoint("4", 4, 3, 1f);
        ...
        assertEquals("2", day, "Incorrect day was returned");
    }
}
